      ...
      <div className="max-w-6xl mx-auto">
        <Reveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-primary mb-4">
              ...
              <span className="text-[#0ea5e9] italic">estos 2 bonos exclusivos</span>
            </h2>
        ...
        <div className="space-y-6 md:space-y-12 max-w-5xl mx-auto">
          ...
          <Reveal delay={200} animation="fade-up">
            <div className="bg-white rounded-[30px] md:rounded-[50px] shadow-xl overflow-hidden border border-purple-100 flex flex-col md:flex-row items-stretch group hover:shadow-[0_20px_60px_rgba(168,85,247,0.15)] transition-all duration-500">
              <div className="p-6 md:p-12 md:w-3/5 flex flex-col justify-center order-2 md:order-1">
                <div className="bg-[#a855f7]/10 text-[#a855f7] w-fit px-3 py-1 md:px-4 md:py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-3 md:mb-6 border border-[#a855f7]/20">
                  BONO EXCLUSIVO #1
                </div>
                ...
                <p className="text-gray-600 leading-relaxed text-sm md:text-lg mb-4 md:mb-8">
                  ¿No sabés qué decir cuando hay un berrinche o tristeza profunda? Estas tarjetas te dan <span className="font-bold text-[#a855f7]">el guion exacto</span> para validar sus emociones sin perder la calma. Sabrás qué decir, qué no decir y cómo conectar en segundos.
                </p>
                <div className="flex items-center gap-3">
                  <div className="bg-[#a855f7] text-white p-2 rounded-lg shadow-lg shadow-purple-200">
                    <MessageCircle className="w-4 h-4 md:w-5 md:h-5" />
                  </div>
                  <span className="text-[#a855f7] font-black text-xs md:text-sm uppercase tracking-widest">
              ...
              <div className="h-48 md:h-auto md:w-2/5 bg-[#a855f7]/5 flex items-center justify-center p-6 md:p-8 relative overflow-hidden group-hover:bg-[#a855f7]/10 transition-colors order-1 md:order-2">
                <div className="absolute inset-0 bg-gradient-to-br from-[#a855f7]/10 to-transparent"></div>
                <img
                  src="https://i.imgur.com/N5ROtye.png"
                  alt="Bono Tarjetas de Frases"
                  className="relative z-10 h-full w-auto object-contain drop-shadow-[0_15px_30px_rgba(168,85,247,0.3)] transform group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-700"
                />
                {/* Decorative elements */}
                <div className="absolute -bottom-4 -right-4 bg-[#a855f7] w-24 h-24 rounded-full blur-3xl opacity-20"></div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={400} animation="fade-up">
            <div className="bg-white rounded-[30px] md:rounded-[50px] shadow-xl overflow-hidden border border-yellow-100 flex flex-col md:flex-row-reverse items-stretch group hover:shadow-[0_20px_60px_rgba(253,216,53,0.15)] transition-all duration-500">
              ...
              <div className="h-48 md:h-auto md:w-2/5 bg-[#fff9c4]/30 flex items-center justify-center p-6 md:p-8 relative overflow-hidden group-hover:bg-[#fff9c4]/50 transition-colors order-1 md:order-2 md:order-reverse">
                ...
                <img
                  src="https://i.imgur.com/P2y4zz8.png"
