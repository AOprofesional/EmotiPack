  ...
  return (
    <section className="py-24 px-4 bg-gray-50 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <a href="https://pay.hotmart.com/T103511301C?checkoutMode=10" target="_blank" rel="noopener noreferrer" className="bg-primary hover:scale-105 transition-transform text-white font-black px-10 py-6 rounded-full flex items-center justify-center gap-4 mx-auto text-lg md:text-xl uppercase shadow-2xl mb-8 w-fit">
