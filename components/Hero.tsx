  ...
  return (
    <section className="relative bg-primary text-white pt-16 pb-24 md:pt-24 md:pb-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <a href="https://pay.hotmart.com/T103511301C?checkoutMode=10" target="_blank" rel="noopener noreferrer" className="bg-accent hover:scale-105 active:scale-95 transition-all text-black font-black px-10 py-6 rounded-full flex items-center gap-3 mx-auto text-sm md:text-lg uppercase shadow-2xl border-b-[6px] border-yellow-600 w-fit">
